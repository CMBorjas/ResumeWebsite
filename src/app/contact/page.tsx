export default function ContactPage() {
  return (
    <section className="max-w-4xl mx-auto pt-8">
      <div className="bg-slate-900/70 backdrop-blur-md rounded-xl p-8 border-2 border-brand-cyan/50 shadow-[0_0_15px_color-mix(in srgb, var(--color-brand-cyan) 30%, transparent)] relative overflow-hidden group">
        ...
        <h2 className="text-3xl font-bold text-brand-cyan drop-shadow-[0_0_8px_color-mix(in srgb, var(--color-brand-cyan) 40%, transparent)] tracking-wide mb-6">
        ...
        <div className="space-y-6">
          {/* Email Block */}
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 p-4 bg-[#0d1117] rounded-lg border border-brand-cyan/30 hover:border-brand-cyan/80 hover:shadow-[0_0_10px_color-mix(in srgb, var(--color-brand-cyan) 30%, transparent)] transition-all">
            ...
            <a className="mt-2 sm:mt-0 w-full sm:w-auto text-center px-6 py-2 bg-brand-cyan/10 border border-brand-cyan/50 text-brand-cyan rounded hover:bg-brand-cyan/20 hover:shadow-[0_0_10px_color-mix(in srgb, var(--color-brand-cyan) 40%, transparent)] transition-all tracking-wide text-sm font-bold" href="mailto:C.mandujano.borjas@gmail.com">
              TRANSMIT
            </a>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 p-4 bg-[#0d1117] rounded-lg border border-brand-cyan/30 hover:border-brand-cyan/80 hover:shadow-[0_0_10px_color-mix(in srgb, var(--color-brand-cyan) 30%, transparent)] transition-all">
            ...
            <a className="mt-2 sm:mt-0 w-full sm:w-auto text-center px-6 py-2 bg-brand-cyan/10 border border-brand-cyan/50 text-brand-cyan rounded hover:bg-brand-cyan/20 hover:shadow-[0_0_10px_color-mix(in srgb, var(--color-brand-cyan) 40%, transparent)] transition-all tracking-wide text-sm font-bold" href="https://www.linkedin.com/in/cchristian-mandujano" target="_blank" rel="noreferrer">
              CONNECT
            </a>
          </div>
        </div>
