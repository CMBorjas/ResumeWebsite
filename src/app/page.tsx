...
export default function Home() {
  ...
  return (
    <div className="w-full flex flex-col items-center pb-24">
      {/* HERO SECTION */}
      <section className="w-full min-h-[95vh] flex flex-col items-center justify-center px-4 mb-16 relative">
        <motion.div 
        ...
        >
          <p className="text-brand-cyan text-sm md:text-base font-mono tracking-[0.2em] mb-6 uppercase flex items-center justify-center gap-3">
            <span className="w-2.5 h-2.5 rounded-full bg-brand-cyan animate-pulse shadow-[0_0_10px_color-mix(in srgb, var(--color-brand-cyan) 80%, transparent)]"></span>
            Welcome to my portfolio
          </p>
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-extrabold text-white leading-tight tracking-tight mb-8">
            I build <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-cyan to-brand-pink drop-shadow-[0_0_15px_color-mix(in srgb, var(--color-brand-cyan) 40%, transparent)]">digital experiences</span>
          </h1>
          <motion.p 
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            Aspiring Software Engineer & Computer Science Student at the University of Colorado Denver. Specializing in highly interactive and performant web applications.
          </motion.p>
          <motion.div
          ...
          >
            <a href="mailto:C.mandujano.borjas@gmail.com" className="px-8 py-4 bg-brand-cyan/10 text-brand-cyan border border-brand-cyan/30 rounded-full font-bold hover:bg-brand-cyan/20 hover:scale-105 hover:shadow-[0_0_20px_color-mix(in srgb, var(--color-brand-cyan) 40%, transparent)] transition-all duration-300">
              Let's Talk
            </a>
            <a href="#bento-grid" className="px-8 py-4 bg-white/5 text-white border border-white/10 rounded-full font-bold hover:bg-white/10 hover:scale-105 transition-all duration-300">
              Explore Work
            </a>
          </motion.div>
        </motion.div>
        ...
        >
          ...
          <motion.div 
            ...
            className="w-0.5 h-12 bg-gradient-to-b from-brand-cyan to-transparent rounded-full"
          />
        </motion.div>
      </section>

      {/* BENTO GRID SECTION */}
      <section id="bento-grid" className="w-full max-w-[1200px] px-4 relative z-20">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 w-full auto-rows-[minmax(180px,auto)]">
